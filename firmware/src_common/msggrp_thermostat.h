...
#ifndef _MSGGRP_THERMOSTAT_H
#define _MSGGRP_THERMOSTAT_H
...
// Message Group "thermostat"
// ==========================
// MessageGroupID: 80

// ENUM for MessageIDs of this MessageGroup
typedef enum {
  MESSAGEID_THERMOSTAT_STATUS = 1
} THERMOSTAT_MessageIDEnum;


// Message "thermostat_status"
// ---------------------------
// MessageGroupID: 80
// MessageID: 1
...
static inline void pkg_header_init_thermostat_status_setget(void)
{
  ...
  pkg_headerext_setget_set_messagegroupid(80);
...
static inline void pkg_header_init_thermostat_status_status(void)
{
  memset(&bufx[0], 0, sizeof(bufx));
  pkg_header_set_messagetype(8);
  pkg_headerext_status_set_messagegroupid(80);
